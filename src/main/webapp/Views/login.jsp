    ...
    <style>
        *, *::before, *::after {
        ...
        .vinyl {
            ...
            filter: drop-shadow(0 0 60px rgba(123,108,255,0.25))
                    drop-shadow(0 0 20px rgba(244,63,142,0.15));
        }
        ...
        .btn-signin:hover         { filter: brightness(1.08); transform: translateY(-1px); box-shadow: 0 0 0 1px rgba(255,255,255,0.12) inset, 0 12px 40px rgba(109,95,255,0.45), 0 2px 8px rgba(0,0,0,0.3); }
        ...
        @media (max-width: 520px) {
            .glass-card { width: 92vw; padding: 36px 28px 32px; }
